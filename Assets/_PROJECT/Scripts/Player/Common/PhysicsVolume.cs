...
namespace ZFGinc.Player.Common
{
    ...
    public class PhysicsVolume : MonoBehaviour
    {
        ...
        {
            if (PlayerInitialization.Instance.FirstPersonCharacter == null) return;
            PlayerInitialization.Instance.FirstPersonCharacter.RemovePhysicsVolume(_collider);
        }
